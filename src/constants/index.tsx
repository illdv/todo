...
export type DELETE_TAB = typeof DELETE_TAB;

export const ADD_TAB = 'ADD_TAB'
export type ADD_TAB = typeof ADD_TAB;




export const FETCH_TASKS_LIST = 'FETCH_TASKS_LIST'
export type FETCH_TASKS_LIST = typeof FETCH_TASKS_LIST;
...
export type CURRENT_ID = typeof CURRENT_ID;
